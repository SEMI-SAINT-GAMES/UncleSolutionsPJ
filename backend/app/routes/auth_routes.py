...
# from core.utilies.auth.auth_utilies import pwd_context, verify_password, create_jwt_token, get_current_username, \
#     hash_password
# from app import db
...
#
# @auth_router.get("/me")
# async def read_me(current_user: dict = Depends(get_current_username)):
